/**
 * CONSULTA PARA ACTUALIZAR EL NOMBRE DE UNA ENTIDAD SIMPLE (PERMISO, ROL)
 *
...
public class UpdateSimpleEntityNombre {
    ...
    String consulta = "MATCH(NODO:$entidad) WHERE Id(NODO) = $id set Nombre = $nombre";
    public UpdateSimpleEntityNombre(Integer id, String entidad, String nombre){
