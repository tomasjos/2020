/**
 * CONSULTA PARA ELIMINAR UNA NUEVA RELACIÓN ENTRE NODOS
 *
...
public class EliminarRelacion {
    String consulta = "match ($nombreEntidadOrigen:$nombreEntidadOrigen)-[rel:$etiqueta]->($nombreEntidadDestino:$nombreEntidadDestino) " +
            "where Id($nombreEntidadOrigen) = $idEntidadOrigen and Id($nombreEntidadDestino) = $idEntidadDestino Delete rel";
    public EliminarRelacion(Pair<Integer, NodosEntities.Nodos> idEntidadOrigen,
